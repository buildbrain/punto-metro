...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-03-2024 a las 21:52:04
...
(3, 'Juan Villegas', 2147483647, 'juan@hotmail.com', '(300) 341-2345', 'Calle 23 # 45 - 56', '1980-11-02', 11, '2024-03-16 19:33:42', '2024-03-17 01:33:42'),
...
(1, 'Administrador', 'admin', '$2a$07$asxx54ahjppf45sd87a5auXBm1Vr2M1NV5t/zNQtGHGpS5fFirrbG', 'Administrador', 'vistas/img/usuarios/admin/191.jpg', 1, '2024-03-16 19:32:50', '2024-03-17 01:32:50'),
...
--
-- Error leyendo la estructura de la tabla facturacion.ventas: #1932 - Table 'facturacion.ventas' doesn't exist in engine
-- Error leyendo datos de la tabla facturacion.ventas: #1064 - Algo está equivocado en su sintax cerca 'FROM `facturacion`.`ventas`' en la linea 1
