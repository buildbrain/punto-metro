...
$ventasOtros = ModeloVentas::mdlRangoFechasVentasDelDiaOtros();
$ventasTranferencias= ModeloVentas::mdlRangoFechasVentasDelDiaTranferencias();
$ventasEnvios= ModeloVentas::mdlRangoFechasVentasDelDiaEnvios();

$conteoEfectivo=0;
 $conteoTarjeta=0;
 $conteoOtros=0;
 $conteoTranferencias=0;
 $conteoEnvios=0;
 $respuesta="";
...
$printer -> text("Cierre de ventas en Tranferencia \n");
$printer -> feed(1);
$printer -> text(" Transacion                   Total". "\n");
$printer -> feed(1);

foreach ($ventasTranferencias as $row => $item){
	$printer -> text(" Tr-".$item["codigo"]."                      ".$item["total"]. "\n");
	$conteoTranferencias = $conteoTranferencias  + $item["total"];
	}
$conteototal = $conteototal + $conteoTranferencias;

$printer -> text("-----------------------------------------"."\n");
	$printer -> text("Total vendido en Tranferencia   --->    ". $conteoTranferencias);
...
$printer -> text("***********************************************************************"."\n");
	...
	$printer -> text("Cierre de ventas en conteoEnvios \n");
	$printer -> feed(1);
	$printer -> text(" Transacion                   Total". "\n");
	$printer -> feed(1);
	
	foreach ($ventasEnvios as $row => $item){
		$printer -> text(" Tr-".$item["codigo"]."                      ".$item["total"]. "\n");
		$conteoEnvios = $conteoEnvios  + $item["total"];
		}
	$conteototal = $conteototal + $conteoEnvios;
	
	$printer -> text("-----------------------------------------"."\n");
		$printer -> text("Total vendido en Envios   --->    ". $conteoEnvios);
...
$printer -> text("Cierre de ventas en Otros \n");
$printer -> feed(1);
$printer -> text(" Transacion                   Total". "\n");
$printer -> feed(1);

foreach ($ventasOtros as $row => $item){
	$printer -> text(" Tr-".$item["codigo"]."                      ".$item["total"]. "\n");
	$conteoOtros = $conteoOtros  + $item["total"];
	}
$conteototal = $conteototal + $conteoOtros;

$printer -> text("-----------------------------------------"."\n");
	$printer -> text("Total vendido en Otros   --->    ". $conteoOtros);
...
$printer -> text("______________________________________________________________________________________________________________________________"."\n");

		$printer -> text("Detalle cualquier problema.");
		$printer -> feed(1);
		$printer -> feed(1);
