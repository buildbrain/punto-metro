...
static public function mdlRangoFechasVentasDelDiaTarjeta(){
	...
	/*=============================================
			$stmt = Conexion::conectar()->prepare("SELECT * FROM 'ventas' WHERE fecha BETWEEN '$fechaActualMasUno' AND '$fechaActualMasUno'");
	=============================================*/
			$stmt = Conexion::conectar()->prepare("SELECT  * FROM `ventas`  WHERE `metodo_pago` = 'tarjeta'  AND DATE(`fecha`) = DATE(NOW()) ;");
...
static public function mdlRangoFechasVentasDelDiaOtros(){
		$fechaActual = new DateTime();
		$fechaActual ->add(new DateInterval("P1D"));
		$fechaActualMasUno = $fechaActual->format("Y-m-d");
		$stmt = Conexion::conectar()->prepare("SELECT  * FROM `ventas`  WHERE `metodo_pago` = 'otros'  AND DATE(`fecha`) = DATE(NOW()) ;");
		$stmt -> execute();
		return $stmt -> fetchAll();
}

static public function mdlRangoFechasVentasDelDiaTranferencias(){
	$fechaActual = new DateTime();
	$fechaActual ->add(new DateInterval("P1D"));
	$fechaActualMasUno = $fechaActual->format("Y-m-d");
	$stmt = Conexion::conectar()->prepare("SELECT  * FROM `ventas`  WHERE `metodo_pago` = 'tranferencia'  AND DATE(`fecha`) = DATE(NOW()) ;");
	$stmt -> execute();
	return $stmt -> fetchAll();
}
...
/*=============================================
		$stmt = Conexion::conectar()->prepare("SELECT * FROM 'ventas' WHERE fecha BETWEEN '$fechaActualMasUno' AND '$fechaActualMasUno'");
=============================================*/
		$stmt = Conexion::conectar()->prepare("SELECT  * FROM `ventas`  WHERE `metodo_pago` = 'envio'  AND DATE(`fecha`) = DATE(NOW()) ;");
